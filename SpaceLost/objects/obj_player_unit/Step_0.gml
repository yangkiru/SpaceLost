...
physics_apply_force(phy_position_x,phy_position_y,lengthdir_x(spd,point_direction(x,y,target_x,target_y)),lengthdir_y(spd,point_direction(x,y,target_x,target_y)));
