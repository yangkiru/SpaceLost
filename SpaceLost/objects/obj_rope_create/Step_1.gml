...
if (init) {
	...
	//physics_joint_weld_create(obj1, obj2, obj2.x, obj2.y, 0, 1, damp, 0);
...
if (!connected && anchor_1 != -1 && anchor_2 != -1) {
	...
	//j_h = physics_joint_weld_create(anchor_1, head, head.phy_position_x, head.phy_position_y, 0, 1, damp, 0);
	//j_h = physics_joint_revolute_create(anchor_1, head, head.phy_position_x, head.phy_position_y, -1, 1, 0, 0 , 0, 0, 0);

	tail.phy_position_x = anchor_2.phy_position_x;
	tail.phy_position_y = anchor_2.phy_position_y;
	//j_t = physics_joint_weld_create(anchor_2, tail, tail.phy_position_x, tail.phy_position_y, 0, 1, damp, 0);
	//j_t = physics_joint_revolute_create(anchor_2, tail, tail.phy_position_x , tail.phy_position_y, -1, 1, 0, 0 , 0, 0, 0);
