if (init) {
	...
	obj1 = instance_create(x, y, obj_rope);
	obj2 = instance_create(x + xx, y, obj_rope);
...
if (!connected && anchor_1 != -1 && anchor_2 != -1) {
	...
	c_h =physics_joint_revolute_create(anchor_1, head, anchor_1.phy_position_x, anchor_1.phy_position_y, -1, 1, 0, 0 , 0, 0, 0);


	tail.phy_position_x = anchor_2.phy_position_x - tail.sprite_width;
	tail.phy_position_y = anchor_2.phy_position_y;

	c_t = physics_joint_revolute_create(anchor_2, tail, anchor_2.phy_position_x, anchor_2.phy_position_y, -1, 1, 0, 0 , 0, 0, 0);
