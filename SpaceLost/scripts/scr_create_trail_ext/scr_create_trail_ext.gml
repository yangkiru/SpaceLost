/// @description scr_create_trail_ext(sprite, index, num_steps, image_x_offset, image_y_offset, x_scale, y_scale, precision, alpha, fade, pinch_end)
/// @param sprite
/// @param  index
/// @param  num_steps
...
/// @param  fade
/// @param  pinch_end
function scr_create_trail_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10) {
